    ...
    <div class="card shadow-sm p-4">
        ...
        <form method="POST" action="{{ route('products.create') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="image" class="form-control" placeholder="Enter image URL" value="{{ old('image') }}">
            </div>
        ...
        <a href="{{ route('products.all') }}" class="btn btn-secondary w-100 mt-3">Back to All Products</a>
